...
export default function Create() {
    ...
    return (
        <>
            <Head title="Créer une déclaration" />
            <div className="container mx-auto p-4 md:p-8">
                <div className="rounded-lg bg-white p-6 dark:bg-gray-800">
                    <div className="mb-6 flex items-center justify-between">
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Créer une Déclaration de Naissance</h1>
                    ...
                    <form onSubmit={submit} className="-md mx-auto max-w-[1000px] space-y-6 rounded p-6 shadow">
                        {/* Section Enfant */}
