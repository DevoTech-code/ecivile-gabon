...
export default function Edit({ declaration }) {
            ...
            <div className="container mx-auto p-4 md:p-8">
                <div className="rounded-lg bg-white p-6 dark:bg-gray-800">
                    <div className="mb-6 flex items-center justify-between">
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Modifier la Déclaration de Naissance</h1>
                    ...
                    <form onSubmit={submit} className="mx-auto max-w-[1000px] space-y-6 rounded-md p-6 shadow">
                        {/* Section Enfant */}
                                ...
                                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => setData('nom_enfant', e.target.value)}
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => setData('prenom_enfant', e.target.value)}
                                            className="mt-1 block w-full"
                                        />
                            ...
                            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('prenom_pere', e.target.value)}
                                        className="mt-1 block w-full"
                                    />
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('nationalite_pere', e.target.value)}
                                        className="mt-1 block w-full"
                                    />
                            ...
                            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('prenom_mere', e.target.value)}
                                        className="mt-1 block w-full"
                                    />
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('nationalite_mere', e.target.value)}
                                        className="mt-1 block w-full"
                                    />
