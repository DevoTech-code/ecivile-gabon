...
import { BookOpen, Check, Download, Folder, LayoutGrid, List, X } from "lucide-react";
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                >
                                    {declaration.statut === "envoyee"
                                        ? "en attente"
                                        : declaration.statut.replace(/_/g, " ")}
                                </Badge>
                            </div>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div>
                                        <Label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                            Acte de naissance de la père
                                        </Label>

                                        {isDocumentProvided(
                                            declaration.acte_naissance_pere
                                        ) ? (
                                    ...
                                    <div>
                                        ...
                                        {isDocumentProvided(
                                            declaration.acte_naissance_mere
                                        ) ? (
                                            <div className="mt-2 flex items-center gap-3">
                                                {/* Bouton Télécharger */}
                                                <a
                            ...
                            {/* Section Actions */}
                            {declaration.statut === "envoyee" && (
                                <div className="mt-8 flex justify-center gap-4 border-t pt-4 flex-col sm:flex-row">
                                    <Button
                ...
                >
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                Veuillez indiquer le motif de rejet. Cette
                                information sera transmise à l'agent d'hôpital.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <div className="py-4">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData("motif_rejet", e.target.value)
