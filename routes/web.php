...
use App\Http\Controllers\Hopital\DeclarationController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/mairie/dashboard', [\App\Http\Controllers\Mairie\DashboardController::class, 'index'])->name('mairie.dashboard');
    Route::get('/hopital/dashboard', [\App\Http\Controllers\Hopital\DashboardController::class, 'index'])->name('hopital.dashboard');
});
...
Route::middleware(['auth', 'verified'])->prefix('hopital')->name('hopital.')->group(function () {
    ...
    Route::post('/declarations/{declaration}/submit', [DeclarationController::class, 'submitDeclaration'])->name('declarations.submit');
    Route::get('declarations/{declaration}/download', [DeclarationController::class, 'download'])->name('declarations.download');
});

// Routes pour les agents des mairies
Route::middleware(['auth', 'verified'])->prefix('mairie')->name('mairie.')->group(function () {
    Route::get('/declarations', [\App\Http\Controllers\Mairie\DeclarationController::class, 'index'])
        ->name('declarations.index');
    Route::get('/declarations/{declaration}', [\App\Http\Controllers\Mairie\DeclarationController::class, 'show'])
        ->name('declarations.show');
    Route::post('/declarations/{declaration}/validate', [\App\Http\Controllers\Mairie\DeclarationController::class, 'validateDeclaration'])
        ->name('declarations.validate');
    Route::post('/declarations/{declaration}/reject', [\App\Http\Controllers\Mairie\DeclarationController::class, 'reject'])
        ->name('declarations.reject');
    Route::get('/declarations/{id}/download', [\App\Http\Controllers\Mairie\DeclarationController::class, 'download'])
